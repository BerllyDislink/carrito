...
if(isset($_SESSION['carrito'])){
  //si existe buscamos si yaestaba agreado ese producto
  if(isset($_GET['id'])){
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="#" class="btn btn-primary btn-sm btnEliminar" data-id="<?php echo $arregloCarrito[$i]['Id']; ?>">Quitar</a></td>
                  </tr>
                  <?php
                  }
                  }
