...
$conexion ->query("insert into usuario (nombre, telefono, email, password,img_perfil,nivel) values( '".$_POST['c_fname']." ".$_POST['c_lname']."','".$_POST['c_phone']."','".$_POST['c_email_address']."','".sha1($password)."','default.jpg','cliente' ) ")or die($conexion ->error);
...
$conexion->query("insert into envios(pais,company,direccion,departamento,cp,id_venta) values
(
  '".$_POST['country']."',
  '".$_POST['c_companyname']."',
  '".$_POST['c_address']."',
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><a href="./index.php" class="btn btn-sm btn-primary">Vuelve a la tienda</a></p>
          </div>
        </div>
      </div>
    </div>
