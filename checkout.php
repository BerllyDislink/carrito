        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="c_state_country" class="text-black">Departamento / Ciudad <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                <label for="c_order_notes" class="text-black">Notas extras</label>
                <textarea name="c_order_notes" id="c_order_notes" cols="30" rows="5" class="form-control" placeholder="Escriba sus notas extras aqui..."></textarea>
              </div>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="border p-3 mb-3">
                    <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsebank" role="button" aria-expanded="false" aria-controls="collapsebank">Pagar directamente al banco</a></h3>

                    <div class="collapse" id="collapsebank">
                      <div class="py-2">
                        <p class="mb-0">Realice el pago directamente en nuestra cuenta bancaria. Utilice su número de pedido como referencia de pago. Su pedido no se enviará hasta que los fondos se hayan compensado en nuestra cuenta.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block"type="submit">Ordene</button>
                  </div>
